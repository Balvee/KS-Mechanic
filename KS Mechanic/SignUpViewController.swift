...
class SignUpViewController:UIViewController, UITextFieldDelegate {
    ...
    var continueButton:CustomButtons!
    ...
    override func viewDidLoad() {
        ...
        continueButton = CustomButtons(frame: CGRect(x: 0, y: 0, width: 200, height: 50))
        ...
        let myCGFlooat = CGFloat(25)
        continueButton.setCornerRadius(deg: myCGFlooat)
